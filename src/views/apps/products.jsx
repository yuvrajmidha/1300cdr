                ...
                {products.map(product => <Flex alignItems="center" justifyContent={"space-between"} bg={color} my={3} shadow="md" p={4} rounded={4}>
                    <Flex alignItems="center">
                        <Box size="64px" mr={4} overflow="hidden" rounded={4}>
                            <img alt="p" height="64px" width="64px" src="https://off.com.ph/-/media/images/off/ph/products-en/products-landing/landing/off_overtime_product_collections_large_2x.jpg?la=en-ph"></img>
                        </Box>
                        <Box>
